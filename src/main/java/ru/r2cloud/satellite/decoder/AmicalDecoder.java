...
public class AmicalDecoder extends TelemetryDecoder {

	public AmicalDecoder(PredictOreKit predict, Configuration config) {
	...
	public BeaconSource<? extends Beacon> createBeaconSource(FloatInput source, ObservationRequest req) {
		...
		return new Ax25BeaconSource<>(demod, Amical1Beacon.class);
	}

	@Override
	public Class<? extends Beacon> getBeaconClass() {
		return Amical1Beacon.class;
	}
