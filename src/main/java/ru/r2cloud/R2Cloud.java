...
public class R2Cloud {
	...
	public R2Cloud(Configuration props) {
		...
		decoders.put("39430", new Gomx1Decoder(props));
		decoders.put("39444", new Ao73Decoder(props));
		decoders.put("40069", new LRPTDecoder(props));
		decoders.put("41460", new Aausat4Decoder(props));
		decoders.put("42017", new Nayif1Decoder(props));
		decoders.put("42784", new PegasusDecoder(props));
		decoders.put("42829", new TechnosatDecoder(props));
		SnetDecoder snetDecoder = new SnetDecoder(props);
		decoders.put("43186", snetDecoder);
		decoders.put("43187", snetDecoder);
		decoders.put("43188", snetDecoder);
		decoders.put("43189", snetDecoder);
		decoders.put("43466", new KunsPfDecoder(props));
		decoders.put("43743", new ReaktorHelloWorldDecoder(props));
		decoders.put("43786", new Itasat1Decoder(props));
		decoders.put("43792", new EseoDecoder(props));
		decoders.put("43798", new AstrocastDecoder(props));
		decoders.put("43803", new Jy1satDecoder(props));
		decoders.put("43804", new Suomi100Decoder(props));
		...
		decoders.put("44406", new Lucky7Decoder(props));
		decoders.put("44830", new Atl1Decoder(props));
		decoders.put("44832", new SmogPDecoder(props));
		decoders.put("44878", new OpsSatDecoder(props));
		decoders.put("44885", new Floripasat1Decoder(props));
