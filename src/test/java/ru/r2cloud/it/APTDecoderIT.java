...
import ru.r2cloud.satellite.AutoGeneratedBytes;
...
public class APTDecoderIT {
	...
	public void testSuccess() throws Exception {
		...
		try (FileOutputStream fos = new FileOutputStream(wav); AutoGeneratedBytes bytes = new AutoGeneratedBytes()) {
			fos.write(bytes.read());
		}
		APTDecoder decoder = new APTDecoder(config, factory);
		APTResult result = decoder.decode(wav, "a");
		assertNull(result.getImage());
		assertEquals("35.3", result.getGain());
