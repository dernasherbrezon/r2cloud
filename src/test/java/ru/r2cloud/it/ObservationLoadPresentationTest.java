...
public class ObservationLoadPresentationTest extends BaseTest {

	@Test
	public void testAuthFailureIfPresentationModeDisabled() {
		HttpResponse<String> response = client.getDataWithResponse("/api/v1/observation/load");
	...
	public void testSuccess() throws Exception {
		...
		JsonObject actual = client.getObservationPresentation("41460", "1559942730784");
		TestUtil.assertJson("aausat4Observation/expected.json", actual);
	}
